...
<h1 class="display-4">Nueva Solicitud
...
<form action="{{route('solicitud.crear')}}" method="POST">
@csrf
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <select class="form-control" id="exampleFormControlSelect3" name="nivel">
      <option>Alta</option>
      <option>Media</option>
      <option>Baja</option>
    </select>
  ...
  <div class="col">
    ...
    <input type="number" name="numeroCamilla" placeholder="N° Camilla" class="form-control mb-2">
    </div>
    </div>
    <div class="col">
    <div class="form-group">
    <label for="formGroupExampleInput">N° Habitacion:</label>
    <input type="number" name="numeroHabitacion" placeholder="N° Habitacion" class="form-control mb-2">
    </div>
    </div>
  ...
  <div class="row">
    ...
    <input type="string" name="solicitante" placeholder="Solicitante" class="form-control mb-2">
    </div>
    </div>
    <div class="col">
    <div class="form-group">
    <label for="formGroupExampleInput">Area:</label>
    <input type="string" name="area" placeholder="Area" class="form-control mb-2">
    </div>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <input type="string" name="tipo" placeholder="Tipo" class="form-control mb-2">
    </div>
    </div>
  </div>
